...
/// <see cref="DeviceIdentityClaim"/> bei der Geräte-Identität. Bewusst nur drei Felder:
/// <c>CustomerGroupId</c> (verhindert, dass eine für einen anderen Kreis gültige Signatur
/// hier akzeptiert würde - zusätzlich zur ohnehin vorgeschalteten
/// <c>CustomerGroupFilter</c>-Prüfung), <c>DeviceId</c> (bindet die Behauptung an genau
/// dieses Gerät, keine Übertragbarkeit auf ein anderes) und <c>SentAtUtc</c>
/// (Replay-Schutz über <see cref="FreshnessWindow"/>).
/// </summary>
