...
namespace HaelpMi.InstallCreator.Interop;
...
///
/// Bewusstes Duplikat von HaelpMi.UI.Interop.NoRecentFileDialog - HaelpMi.InstallCreator hat
/// keine ProjectReference auf HaelpMi.UI/Core (siehe HaelpMi.InstallCreator.csproj).
/// </summary>
