...
/// <summary>
/// Bewusstes Duplikat von HaelpMi.Core.Interop.ForegroundHelper (CLAUDE.md/ClipboardCopier-
/// Vorbild: HaelpMi.InstallCreator hat absichtlich kein ProjectReference auf HaelpMi.Core).
/// Holt das Fenster beim manuellen Start dieses Entwickler-Tools einmalig in den
/// Vordergrund (Issue #99), per AttachThreadInput-Workaround gegen Windows' Foreground-
/// Stealing-Prevention.
/// </summary>
